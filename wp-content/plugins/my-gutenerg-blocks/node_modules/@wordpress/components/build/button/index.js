...
function useDeprecatedProps({
  ...
  if (isDefault) {
    ...
    (0, _deprecated.default)('wp.components.Button `isDefault` prop', {
      since: '5.4',
...
function UnforwardedButton(props, ref) {
  ...
  const elementChildren = /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [icon && iconPosition === 'left' && /*#__PURE__*/(0, _jsxRuntime.jsx)(_icon.default, {
      icon: icon,
      size: iconSize
    }), text && /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
      children: text
    }), children, icon && iconPosition === 'right' && /*#__PURE__*/(0, _jsxRuntime.jsx)(_icon.default, {
      icon: icon,
      size: iconSize
    })]
  });
  const element = Tag === 'a' ? /*#__PURE__*/(0, _jsxRuntime.jsx)("a", {
    ...anchorProps,
    ...additionalProps,
    ...disableEventProps,
    ...commonProps,
