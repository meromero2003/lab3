...
export type CustomSelectButtonSize = CustomSelectSize<'compact' | 'default' | 'small'>;
...
export type CustomSelectProps = _CustomSelectProps & CustomSelectButtonProps & CustomSelectSize;
/**
