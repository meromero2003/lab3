 ...
 */
const getBlockTypes = exports.getBlockTypes = (0, _data.createSelector)(state => Object.values(state.blockTypes), state => [state.blockTypes]);
 ...
 */
const getBlockVariations = exports.getBlockVariations = (0, _data.createSelector)((state, blockName, scope) => {
  ...
  for (const variation of variations) {
    if (Array.isArray(variation.isActive)) {
      ...
      const isMatch = definedAttributes.every(attribute => {
        const attributeValue = (0, _utils.getValueFromObjectPath)(attributes, attribute);
        if (attributeValue === undefined) {
          return false;
        }
        return attributeValue === (0, _utils.getValueFromObjectPath)(variation.attributes, attribute);
      });
 ...
 */
const getChildBlockNames = exports.getChildBlockNames = (0, _data.createSelector)((state, blockName) => {
...
function getNormalizedSearchTerm(term) {
  return (0, _removeAccents.default)(term !== null && term !== void 0 ? term : '').toLowerCase().trim();
}
...
const __experimentalHasContentRoleAttribute = exports.__experimentalHasContentRoleAttribute = (0, _data.createSelector)((state, blockTypeName) => {
