...
exports.createBlockEditFilter = createBlockEditFilter;
exports.createBlockListBlockFilter = createBlockListBlockFilter;
exports.createBlockSaveFilter = createBlockSaveFilter;
...
exports.useStyleOverride = useStyleOverride;
...
function shouldSkipSerialization(blockNameOrType, featureSet, feature) {
  const support = (0, _blocks.getBlockSupport)(blockNameOrType, featureSet);
...
function useStyleOverride({
  ...
  const fallbackId = (0, _element.useId)();
...
function createBlockEditFilter(features) {
  ...
  const withBlockEditHooks = (0, _compose.createHigherOrderComponent)(OriginalBlockEdit => props => {
    ...
    return [...features.map((feature, i) => {
      ...
      const shouldDisplayControls = context[_context.mayDisplayControlsKey] || context[_context.mayDisplayParentControlsKey] && shareWithChildBlocks;
    ...
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(OriginalBlockEdit, {
      ...props
    }, "edit")];
  }, 'withBlockEditHooks');
  (0, _hooks.addFilter)('editor.BlockEdit', 'core/editor/hooks', withBlockEditHooks);
}
function BlockProps({
  index,
  useBlockProps,
...
function createBlockListBlockFilter(features) {
  const withBlockListBlockHooks = (0, _compose.createHigherOrderComponent)(BlockListBlock => props => {
    ...
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(BlockListBlock, {
      ...props,
      wrapperProps: allWrapperProps.filter(Boolean).reduce((acc, wrapperProps) => {
        return {
          ...acc,
          ...wrapperProps,
          className: (0, _clsx.default)(acc.className, wrapperProps.className),
          style: {
            ...acc.style,
            ...wrapperProps.style
          }
  ...
  (0, _hooks.addFilter)('editor.BlockListBlock', 'core/editor/hooks', withBlockListBlockHooks);
}
function createBlockSaveFilter(features) {
  ...
  (0, _hooks.addFilter)('blocks.getSaveContent.extraProps', 'core/editor/hooks', extraPropsFromHooks, 0);
  (0, _hooks.addFilter)('blocks.getSaveContent.extraProps', 'core/editor/hooks', props => {
