...
function getStylesDeclarations(blockStyles = {}, selector = '', useRootPaddingAlign, tree = {}, disableRootPadding = false) {
  ...
  extraRules.forEach(rule => {
    ...
    if (typeof ruleValue !== 'string' && ruleValue?.ref) {
      ...
      ruleValue = compileStyleValue((0, _object.getValueFromObjectPath)(tree, refPath));
        ...
        spacingStyles.forEach(spacingStyle => {
          ...
          if (declarations.length) {
            ...
            if (!hasBlockGapSupport) {
              ...
              combinedSelector = selector === _utils.ROOT_BLOCK_SELECTOR ? `.${className}${spacingStyle?.selector || ''}` : `${selector}-${className}${spacingStyle?.selector || ''}`;
            }
...
function useGlobalStylesOutputWithConfig(mergedConfig = {}, disableRootPadding) {
  ...
  mergedConfig = (0, _themeFileUriUtils.setThemeFileUris)(mergedConfig, mergedConfig?._links?.['wp:theme-file']);
