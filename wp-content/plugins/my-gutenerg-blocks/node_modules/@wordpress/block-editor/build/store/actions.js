...
exports.insertBeforeBlock = exports.insertAfterBlock = exports.hideInsertionPoint = exports.flashBlock = void 0;
...
const __unstableSetEditorMode = mode => ({
  ...
  if (mode === 'zoom-out') {
    ...
    const {
      sectionRootClientId
    } = (0, _lockUnlock.unlock)(registry.select(_constants.STORE_NAME).getSettings());
